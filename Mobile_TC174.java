 ...
 * Subject : CJ Mall 
 * Name : TC_174
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 쇼핑찜 > 상품명 탭 확인
 * Assertion : "상품명" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC174 {
	...
	@Test
	public void MyzoneShoppingzzimTradeName() throws Exception {
		...
		try {
			...
			// 쇼핑찜 버튼 클릭
	  		...
	  		// 상품명 탭 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[4]/div/p/a")));
		  	System.out.println("상품명 탭 기다림");
	  		
			// 상품명 탭 버튼 클릭
			element = driver.findElement(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[4]/div/p/a"));
	  		element.click();
		  	System.out.println("상품명 탭 버튼 클릭");
	  		
	  		// 상품명 탭 'V' 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[4]/div/p/span")));			
		  	System.out.println("상품명 탭 'V' 기다림");
			
			// 상품명 탭 'V' text 체크
			if ("".equals(driver.findElement(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[4]/div/p/span")).getText())) {
				System.out.println("[TC_174] success");
				assertTrue(true);
				return;
				
			} else {
		    	System.out.println("[TC_174] failure : '상품명' 불일치");
				assertTrue(false);
			}
