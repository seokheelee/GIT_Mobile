 ...
 * Subject : CJ Mall 
 * Name : TC_145
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 주문내역/배송현황 - 현재일부터 1개월 검색 페이지로 이동
 * Assertion : "1개월" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC145 {
	...
	@Test
	public void Myzone1month() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[1]/a"));
	  		...
	  		// 1개월 탭 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/div[2]/ul/li[1]/div/p/a")));
		  	System.out.println("1개월 탭  기다림");
			
			// 1개월 탭 클릭
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[2]/ul/li[1]/div/p/a"));
	  		element.click();
			...
			if ("".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[2]/ul/li[1]/div/p/span")).getText())) {
				System.out.println("[TC_145] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_145] failure : '1개월' 불일치");
				assertTrue(false);
			}
