 ...
 * Subject : CJ Mall 
 * Name : TC_178
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 쇼핑찜 > 장바구니
 * Assertion : 장바구니 버튼 Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC178 {
	...
	@Test
	public void MyzoneShoppingzzimBasket() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[6]/a"));
	  		...
	  		// 장바구니 버튼  기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='jjimList']/li[1]/div[2]/div[2]/p/a")));
		  	System.out.println("장바구니 버튼 기다림");

			// 장바구니 text 체크
			if ("장바구니".equals(driver.findElement(By.xpath(".//*[@id='jjimList']/li[1]/div[2]/div[2]/p/a")).getText())) {
				System.out.println("[TC_178] success");
				assertTrue(true);
				return;
				
			} else {
		    	System.out.println("[TC_178] failure : 장바구니 불일치");
				assertTrue(false);
			}
