 ...
 * Subject : CJ Mall 
 * Name : TC_172
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 쇼핑찜 > 고가 탭 확인
 * Assertion : "고가" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC172 {
	...
	@Test
	public void MyzoneShoppingzzimHighPrice() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[6]/a"));
	  		...
	  		// 고가 탭 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[2]/div/p")));
		  	System.out.println("고가 탭 기다림");
	  		
			// 고가 탭 버튼 클릭
			element = driver.findElement(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[2]/div/p"));
	  		element.click();
		  	System.out.println("고가 탭 버튼 클릭");
	  		
	  		// 고가 탭 'V' 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[2]/div/p/span")));			
		  	System.out.println("고가 탭 'V' 기다림");
			
			// 고가 탭 'V' text 체크
			if ("".equals(driver.findElement(By.xpath(".//*[@id='ct']/form/div[1]/ul/li[2]/div/p/span")).getText())) {
				System.out.println("[TC_172] success");
				assertTrue(true);
				return;
				
			} else {
		    	System.out.println("[TC_172] failure : '고가' 불일치");
				assertTrue(false);
			}
