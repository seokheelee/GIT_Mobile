	...
	public void LoginAlertTextCheck() throws Exception {
		...
		try {
			...
			driver.findElement(By.xpath(".//*[@id='wrapper_cate_left']/dl/dt/a")).click();
	  		...
	  		// 아이디 찾기 버튼 기다림
		    wait = new WebDriverWait(driver, waitTime);
		  	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='memberArea']/div[2]/ul[1]/li[1]/a")));
		  	System.out.println("아이디 찾기 버튼 기다림");
			
			 // 아이디 찾기 버튼 클릭
			driver.findElement(By.xpath(".//*[@id='memberArea']/div[2]/ul[1]/li[1]/a")).click();
		  	System.out.println("아이디 찾기 버튼 클릭");

			// 이름 항목 기다림
		  	wait = new WebDriverWait(driver, waitTime);
		  	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='mb_name']")));
		  	System.out.println("이름 항목 기다림");
			
			 // 개인정보 입력
		  	driver.findElement(By.id("mb_name")).sendKeys(name);
		  	driver.findElement(By.id("mb_birth")).sendKeys(birth);
      	  	System.out.println("개인정보 입력");
      	  	
		  	isExist = existElement(driver,By.xpath(".//*[@id='simple_wrap']/h1/a/span"),"");
		  	if(isExist){
		  		Point hoverItem = driver.findElement(By.xpath(".//*[@id='simple_wrap']/h1/a/span")).getLocation();
		  		((JavascriptExecutor)driver).executeScript("window.scrollBy(0,"+(hoverItem.getY())+ ");");
		  		System.out.println("아이디 일부 ** 표시");
		  	}
			...
			// 아이디 값 뜰 때까지 기다림
			 wait = new WebDriverWait(driver, waitTime);
			 wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='idpw_wrap_main']/div/p/strong")));
      	  	System.out.println("아이디 값 뜰 때까지 기다림");
      	  	
			 	         
	  		// ID 체크
			 if ("ohgun0**6".equals(driver.findElement(By.xpath(".//*[@id='idpw_wrap_main']/div/p/strong")).getText())) {
				 System.out.println("[TC_083] success");
				 assertTrue(true);
				 return;
			 } else {
				 System.out.println("[TC_083] failure : 'ID' 불일치");
				 assertTrue(false);
			 }
