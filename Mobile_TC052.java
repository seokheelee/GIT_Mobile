...
public class Mobile_TC052 {
	...
	@Test
	public void LiveEasyPurchase() throws Exception {
...
//				((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/a/div[1]/img")));
		  	...
		  	isExist = existElement(driver,By.xpath(".//*[@id='tvLive']/div[3]/div/ul/li/a"),"비교상품 or 상담신청");
		  	isExist2 = existElement(driver, By.xpath(".//*[@id='tvLive']/div[3]/div/div[1]/span[1]"),"ONAIR img"); // 생방송 ONAIR img

		  	if(isExist || isExist2 == false)
		  	{
		  		if(isExist2){
		  			wait = new WebDriverWait(driver, waitTime);
				  	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='tvLive']/div[3]/div/ul/li/a")));
		  			element = driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/ul/li/a"));
			  		...
			  		{
			  			System.out.println("[TC_052] failure :"+ element.getText() +"입니다. 다른 시간대 검증필요. 여기서 종료");
			  			assertTrue(true);
			  		   	return;
		  			...
		  			System.out.println("[TC_052] failure : 생방송 상품 시간 아님. 다른 시간대 검증필요. ONAIR 이미지 보이지 않음. 여기서 종료");
		  			assertTrue(true);
		  		   	return;
		  		}
		  	}
