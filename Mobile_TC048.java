...
public class Mobile_TC048 {
	...
	public void LiveTime() throws Exception {
		...
		try {
			...
			// 00:00:00 남음 text 체크
			if(driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/div[1]/span[2]")).getText().indexOf("남음") >=0)
			{
				System.out.println("[TC_048] success");
				assertTrue(true);
				return;
			} 
			else 
			{
		    	System.out.println("[TC_048] failure : '00:00:00 남음' 불일치");
				assertTrue(false);
			}
