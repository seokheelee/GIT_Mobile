 ...
 * Subject : CJ Mall 
 * Name : TC_139
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 예치금
 * Assertion : "예치금" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC139 {
	...
	@Test
	public void MyzoneBalance() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
	  		...
	  		// 예치금 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/div[1]/ul[2]/li[3]/span[1]")));
		  	System.out.println("예치금 기다림");

	  		
		    // 예치금 text 체크
			if ("예치금".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[1]/ul[2]/li[3]/span[1]")).getText())) {
				System.out.println("[TC_139] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_139] failure : '예치금' 불일치");
				assertTrue(false);
			}
