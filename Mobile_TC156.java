 ...
 * Subject : CJ Mall 
 * Name : TC_156
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 주문취소/교환/반품 > 신청내역조회 > 1개월 탭으로 이동
 * Assertion : "1개월" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC156 {
	...
	@Test
	public void MyzoneeOrderWithdrawa1month() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[2]/div/div/div[2]/p/a"));
	  		...
	  		// 1개월 탭 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/div[3]/ul/li[1]/div/p")));
		  	System.out.println("1개월 탭 기다림");
	  		
			// 1개월 탭 클릭
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[1]/div/p"));
	  		element.click();
		  	System.out.println("1개월 탭 클릭");
	  		
	  		// 1개월 탭 'V' 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/div[3]/ul/li[1]/div/p/span")));			
		  	System.out.println("1개월 탭 'V' 기다림");			

			// 1개월 탭 'V' text 체크
			if ("".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[1]/div/p/span")).getText())) {
				System.out.println("[TC_156] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_156] failure : '1개월' 불일치");
				assertTrue(false);
			}
