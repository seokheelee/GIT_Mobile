...
public class Mobile_TC066 {
	...
	@Test
	public void ShoppingBasketNonLogin() throws Exception {
		...
		try {
		    ...
		    wait = new WebDriverWait(driver, waitTime);
		  	...
		  	// "로그인" Text 체크
			if ("로그인".equals(driver.findElement(By.xpath(".//*[@id='o1h_header_wrap']/div/span")).getText())) {
				System.out.println("[TC_066] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_066] failure : '로그인' Text 불일치");
				assertTrue(false);
			}
