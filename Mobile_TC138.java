 ...
 * Subject : CJ Mall 
 * Name : TC_138
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 상품권
 * Assertion : "상품권" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC138 {
	...
	@Test
	public void MyzoneGiftcard() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
	  		...
	  		// 상품권 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ct']/div[1]/ul[1]/li[3]/span[1]")));
		  	System.out.println("상품권 기다림");

	  		
		    // 상품권 text 체크
			if ("상품권".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[1]/ul[1]/li[3]/span[1]")).getText())) {
				System.out.println("[TC_138] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_138] failure : '상품권' 불일치");
				assertTrue(false);
			}
