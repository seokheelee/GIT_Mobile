...
public class Mobile_TC001 {
	...
	public void categoryView() throws Exception {
		...
		try {
			...
			System.out.println("타이틀바 카테고리 버튼 기다림");
			
			boolean isExist2 = existElement(driver, By.xpath(".//*[@id='o1h_header_wrap']/dl/dt/a"), "카테고리바");
			if(isExist2){
				System.out.println("[TC_001] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_001] failure : Time out or XPath 불일치");
				assertTrue(false);
			}
