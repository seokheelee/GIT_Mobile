 ...
 * Subject : CJ Mall 
 * Name : TC_181
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 쇼핑찜 > 선택삭제
 * Assertion : 선택삭제 이동 확인
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC181 {
	...
	@Test
	public void MyzoneShoppingzzimSelectDelete() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
		  	...
		  	// 쇼핑찜 위치로 스크롤 이동
		  	Point hoverItem = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[6]/a")).getLocation();
		  	((JavascriptExecutor)driver).executeScript("window.scrollBy(0,"+(hoverItem.getY())+");");
		  	System.out.println("쇼핑찜 위치로 스크롤 이동");
			...
			if ("선택삭제".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[1]/div/ul/li[1]/p/a")).getText())) {
		    	...
		    	System.out.println("[TC_181] failure : 섡택삭제 불일치");
				assertTrue(false);
			}
