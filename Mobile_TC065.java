...
public class Mobile_TC065 {
	...
	@Test
	public void ShoppingBasket() throws Exception {
		...
		try {
			...
			// 하단 '장바구니' 버튼 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_footer']/nav/ul/li[4]/a")));
		  	System.out.println("하단 '장바구니' 버튼 기다림");
			
			 // 하단 '장바구니' 버튼 클릭
			driver.findElement(By.xpath(".//*[@id='o1h_footer']/nav/ul/li[4]/a")).click();
		  	System.out.println("하단 '장바구니' 버튼 클릭");
			
			// "장바구니" Text 기다림.
		    wait = new WebDriverWait(driver, waitTime);
		  	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
		  	System.out.println("'장바구니' text 기다림");
		  	
		  	// "장바구니" Text 체크
			if ("장바구니".equals(driver.findElement(By.xpath(".//*[@id='o1h_header_wrap']/div/span")).getText())) {
				System.out.println("[TC_065] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_065] failure : '장바구니' Text 불일치");
				assertTrue(false);
			}
