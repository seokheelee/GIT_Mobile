	...
	public void savingButtonView() throws Exception {
		...
		try {
		    ...
		    wait = new WebDriverWait(driver, waitTime);
		  	...
		  	System.out.println("\"CJmall 앱으로 TV방송상품 구매시 5% CJ ONE 포인트\" 이미지 뜰 때까지 기다림");
		  	Thread.sleep(3000);
		  	
		  	// "CJmall 앱으로 TV방송상품 구매시 5% CJ ONE 포인트" img alt 체크
		  	if("CJmall 앱으로 TV방송상품 구매시 5% 적립금 추가지급".equals(driver.findElement(By.xpath(".//*[@id='evt_wrap']/div[1]/h1/img")).getAttribute("alt"))
				...
				return;
	  			...
	  			System.out.println("[TC_017] failure : 'CJmall 앱으로 TV방송상품 구매시 5% 적립금 추가지급' img alt 불일치");
	  			assertTrue(false);
	  		   	return;
	  		}
		} catch (Exception e) {
