...
public class Mobile_TC158 {
	...
	@Test
	public void MyzoneeOrderWithdrawa6month() throws Exception {
		...
		try {
			...
			// 6개월 탭 'V' text 체크
			if ("".equals(driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[3]/div/p/span")).getText())) {
				System.out.println("[TC_158] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_158] failure : '6개월' 불일치");
				assertTrue(false);
			}
