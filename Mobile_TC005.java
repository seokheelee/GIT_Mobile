...
public class Mobile_TC005 {
	...
	@Test
	public void OLIVEYOUNGView() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='o1h_header_wrap']/dl/dt/a"));
	  		...
	  		// OLIVE YOUNG 버튼 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='view']/div/div/div[2]/ul/li[2]/a")));
		    ...
		    for(int i = 0; i<100; i++){
		    	if(driver.getTitle().equals("OLIVE YOUNG")){
		    		break;
		    	} else if (i < 100) {
					...
					System.out.println("[TC_005] failure : Time out");
					assertTrue(false);
				}
		    }
			
		    // 브라우저 Title "OLIVE YOUNG" 체크
			boolean isExist2 = existElement(driver, By.xpath(".//*[@id='header']/div/h1/a"), "OLIVE YOUNG");
		    if(isExist2 && driver.getTitle().equals("OLIVE YOUNG")){
		    	System.out.println("[TC_005] success");
				assertTrue(true);
				return;
		    } else {
		    	System.out.println("[TC_005] failure : 브라우저 Title 'OLIVE YOUNG' 불일치");
				assertTrue(false);
			}
		} catch (Exception e) {
			e.printStackTrace();
