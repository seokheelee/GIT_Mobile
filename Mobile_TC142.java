 ...
 * Subject : CJ Mall 
 * Name : TC_142
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 할인쿠폰 클릭시 내 쿠폰 리스트 - 할인쿠폰 페이지로 이동
 * Assertion : "내 쿠폰 리스트 - 할인쿠폰" Title 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC142 {
	...
	@Test
	public void MyzoneDiscountCoupon() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
	  		...
	  		// 할인쿠폰 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='stEtc']")));
		  	System.out.println("할인쿠폰 기다림");
			
			// 할인쿠폰 클릭
			element = driver.findElement(By.xpath(".//*[@id='stEtc']"));
	  		element.click();
	  		...
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/div/span")));
		  	System.out.println("내 쿠폰 리스트 - 할인쿠폰 기다림");
	  		
		    // 브라우저 Title "내 쿠폰 리스트 - 할인쿠폰" 체크
			boolean isExist2 = existElement(driver, By.xpath(".//*[@id='o1h_header_wrap']/div/span"), "내 쿠폰 리스트 - 할인쿠폰");
		    if(isExist2 && driver.getTitle().equals("내 쿠폰 리스트 - 할인쿠폰")){
		    	System.out.println("[TC_142] success");
				assertTrue(true);
				return;
		    } else {
		    	System.out.println("[TC_142] failure : 브라우저 Title '내 쿠폰 리스트 - 할인쿠폰' 불일치");
				assertTrue(false);
			}
