...
public class Mobile_TC062 {
	...
	public void HomeButton() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_footer']/nav/ul/li[1]/a")));
		  	System.out.println("하단 '홈' 버튼 기다림");
			
			 // 하단 '홈' 버튼 클릭
			driver.findElement(By.xpath(".//*[@id='o1h_footer']/nav/ul/li[1]/a")).click();
		  	System.out.println("하단 '홈' 버튼 클릭");
			
			// 상단의 "CJmall" 로고 뜰 때까지 기다림.
		    wait = new WebDriverWait(driver, waitTime);
		  	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='o1h_header_wrap']/dl/dt/h1/a")));
		  	System.out.println("상단의 \"CJmall\" 로고 뜰 때까지 기다림");
		  	
		  	// "CJmall" Text 체크
			if ("CJ mall".equals(driver.findElement(By.xpath(".//*[@id='o1h_header_wrap']/dl/dt/h1/a")).getText())) {
				System.out.println("[TC_062] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_062] failure : 'CJmall' Text 불일치");
				assertTrue(false);
			}
