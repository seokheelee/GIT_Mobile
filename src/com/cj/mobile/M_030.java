...
public class M_030 {
	...
	public void m_030() throws Exception {
		...
		Thread.sleep(7000);
		//장바구니
		System.out.println(driver.findElement(By.xpath("//*[@id='header']/div[2]/a[3]/div/span[1]")).getText());
		// text check
		if ("장바구니".equals(
				driver.findElement(By.xpath("//*[@id='header']/div[2]/a[3]/div/span[1]")).getText())) {
