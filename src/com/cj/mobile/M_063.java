...
public class M_063 {
	...
	public void m_063() throws Exception {
		...
		Thread.sleep(3000);
		//주문접수 진입
		driver.findElement(By.xpath("//*[@id='content']/div/div[2]/div/ul[1]/li[1]/a")).click();
		System.out.println("주문접수 진입");
		Thread.sleep(3000);
		//주문취소 클릭
		driver.findElement(By.xpath("//*[@id='content']/div/div[2]/div[1]/div/div/div[2]/div/button[4]")).click();
		System.out.println("주문취소 진입");
		Thread.sleep(3000);
		
		//체크박스 선택
		driver.findElement(By.xpath("//*[@id='content']/div/form/fieldset/div[1]/div[2]/span/label/span")).click();
		System.out.println("주문취소 진입");
		Thread.sleep(3000);
		//취소 사유 선택
	    new Select(driver.findElement(By.xpath("//*[@id='cancel_code']"))).selectByVisibleText("단순변심");
		System.out.println("단순변심 클릭");
		Thread.sleep(3000);
		//주문취소
	    driver.findElement(By.xpath("//*[@id='btn_ordercancel']")).click();
		System.out.println("주문취소 클릭");
		Thread.sleep(3000);
		...
		if ("주문/배송 조회".equals(driver.findElement(By.xpath(".//*[@id='header']/div/h1")).getText())) {
			Thread.sleep(3000);
