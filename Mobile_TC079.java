...
public class Mobile_TC079 {
	...
	@Test
	public void LoginNameCheck2() throws Exception {
		...
		try {
		    ...
		    wait = new WebDriverWait(driver, waitTime);
		  	...
		  	System.out.println("'~님' Text 기다림");
		  	
		  	// "~님" Text 체크
			if(driver.findElement(By.xpath(".//*[@id='wrapper_cate_left']/dl/dt/span")).getText().indexOf("님") >=0){
				System.out.println("[TC_079] success");
				assertTrue(true);
				return;
			} else {
				System.out.println("[TC_079] failure : '~님' Text 불일치");
				assertTrue(false);
			}
