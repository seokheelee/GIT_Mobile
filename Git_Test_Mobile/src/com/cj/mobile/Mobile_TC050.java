...
public class Mobile_TC050 {
	...
	@Test
	public void LivePoprietaryPrice() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='tvLive']/div[3]/div/a/div[2]/span[2]/em")));
		  	System.out.println("상품가격 ~원 text 기다림");
	  		
	  		// 상품가격 ~원 text 체크
			if(driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/a/div[2]/span[2]/em")).getText().indexOf("원") >=0)
			{
			...
			{
		    	System.out.println("[TC_050] failure : '상품가격' 불일치");
				assertTrue(false);
			}
