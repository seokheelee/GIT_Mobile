...
public class Mobile_TC009 {
	...
	@Test
	public void productNameView() throws Exception {
		...
		try {
			...
			// 상품명 XPath Text 'null' 여부 체크
		  	isExist3 = existElement(driver, By.xpath(".//*[@id='ct']/div/div[4]/div/a/div[2]/span[1]"), "상품명"); // 상품명
			if(isExist3){
				if(!"".equals(driver.findElement(By.xpath(".//*[@id='ct']/div/div[4]/div/a/div[2]/span[1]")).getText())){
					System.out.println("[TC_009] success");
					assertTrue(true);
					return;
				} else {
					System.out.println("[TC_009] failure : 상품명 Text null...");
					assertTrue(false);
				}
			} else {
				System.out.println("[TC_009] true : 생방송 상품 시간 아님. 다른 시간대 검증필요.");
				assertTrue(true);
			}
		} catch (Exception e) {
			e.printStackTrace();
