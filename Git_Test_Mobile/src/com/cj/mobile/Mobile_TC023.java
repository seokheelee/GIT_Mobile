 ...
 * Subject : CJ Mall 
 * Name : TC_023
 * Scenario : 전시 > 오클락 딜 > 딜 카테고리 > "패션/언더웨어" 카테고리 노출
 * Assertion : "패션/언더웨어" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */

public class Mobile_TC023 {
	...
	@Test
	public void fashionUnderwearView() throws Exception {
		...
		try {
			...
			if(isExist4){
		  	...
		  	// "패션/언더웨어" Text 체크
		  	isExist = existElement(driver,By.xpath(".//*[@id='ct']/div/div[8]/div[1]/div/div/ul/li[2]/a/span"),"패션/언더웨어");
		  	if(isExist){
		  		if("패션/언더웨어".equals(driver.findElement(By.xpath(".//*[@id='ct']/div/div[8]/div[1]/div/div/ul/li[2]/a/span")).getText())){
		  			System.out.println("[TC_023] success");
					assertTrue(true);
					return;
		  		} else {
		  			System.out.println("[TC_023] failure : '패션/언더웨어' Text 불일치");
		  			assertTrue(false);
		  		   	return;
		  		}
		  	} else {
		  		System.out.println("[TC_023] failure : Time out...");
	  			assertTrue(false);
	  		   	return;
		  	}
		} catch (Exception e) {
