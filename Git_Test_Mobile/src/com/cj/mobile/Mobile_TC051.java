 ...
 * Subject : CJ Mall 
 * Name : TC_051
 * Scenario : 전시 > TV쇼핑 > 생방송
 * Assertion : 혜택체크  체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC051 {
	...
	@Test
	public void LiveBenefit() throws Exception {
...
//				((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/a/div[1]/img")));
	  		...
	  		// 생방송 화면 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='tvLive']/div[3]/div/a")));
		  	System.out.println("생방송 화면 기다림");
	  		
			// 생방송 화면 클릭
			element = driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/a"));
	  		element.click();
		  	System.out.println("생방송 화면 클릭");

	  		// 혜택 정보 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='btnArea']/ul[1]/li")));
		  	System.out.println("혜택 정보 기다림");

	  		// 혜택 체크
			if(driver.findElement(By.xpath(".//*[@id='btnArea']/ul[1]/li")).getText().indexOf("") >=0)
			{
			...
			{
		    	System.out.println("[TC_051] failure : '혜택' 불일치");
				assertTrue(false);
			}
