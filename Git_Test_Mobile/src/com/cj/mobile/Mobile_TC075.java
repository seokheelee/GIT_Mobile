 ...
 * Subject : CJ Mall 
 * Name : TC_075
 * Scenario : 전시 > 상단메뉴 > 로그인 > 회원가입 > CJ ONE 회원가입
 * Assertion : 회원가입 Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */

public class Mobile_TC075 {
	...
	public void Joining() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='wrapper_cate_left']/dl/dt/a"));
	  		...
	  		// 회원가입 버튼 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='memberArea']/div[2]/ul[1]/li[3]/a")));
		  	System.out.println("회원가입 버튼 기다림");

	  		// 회원가입 버튼 클릭			
			element = driver.findElement(By.xpath(".//*[@id='memberArea']/div[2]/ul[1]/li[3]/a"));
	  		element.click();
		  	System.out.println("회원가입 버튼 클릭");

			// 회원가입 창 이동	  				
	  		driver.get("https://m.cjone.com:8443/cjmmobile/member/meberjoinstep1.do?coopco_cd=7050&brnd_cd=5000&mcht_no=30&pic=FM02");
		  	System.out.println("회원가입 창 이동");
			
	  		// 회원가입 Title 기다림.
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='conWrap']/h3")));
		  	System.out.println("회원가입 Title 기다림");	  		
		    
			if ("회원가입".equals(driver.findElement(By.xpath(".//*[@id='conWrap']/h3")).getText())) 
			{
				System.out.println("[TC_075] success");
				assertTrue(true);
				return;
			}
			else 
			{
		    	System.out.println("[TC_075] failure : '회원가입' 불일치");
				assertTrue(false);
			}
