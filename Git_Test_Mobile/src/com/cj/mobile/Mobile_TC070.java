	...
	public void Login() throws Exception {
		...
		try {
		    ...
		    wait = new WebDriverWait(driver, waitTime);
		  	...
		  	// "로그인" Text 체크
			if ("로그인".equals(driver.findElement(By.xpath(".//*[@id='wrapper_cate_left']/dl/dt/a")).getText())) {
				System.out.println("[TC_070] success");
				assertTrue(true);
				return;
			} else {
		    	System.out.println("[TC_070] failure : '로그인' Text 불일치");
				assertTrue(false);
			}
