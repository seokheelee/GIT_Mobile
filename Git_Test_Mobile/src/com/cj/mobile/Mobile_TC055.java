 ...
 * Subject : CJ Mall 
 * Name : TC_055
 * Scenario : 전시 > TV쇼핑 > 지금 방송중인 다른상품 > 상품 타이틀 노출
...
//				((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath(".//*[@id='tvLive']/div[3]/div/a/div[1]/img")));
		  	...
		  	if(isExist)
		  	{
		  		if(!"".equals(driver.findElement(By.xpath(".//*[@id='prd_flickwrap']/div/ul/li/a/div[2]/span[1]")).getText())){
		  			System.out.println("[TC_055] success");
					assertTrue(true);
					return;
		  		} else {
		  			System.out.println("[TC_055] failure : 상품명 null...");
		  			assertTrue(false);
		  		   	return;
		  		}
		  	} else {
		  		System.out.println("[TC_055] success : '지금 방송중인 다른상품' 방송시간대 아님. 여기서 종료 ");
	  			assertTrue(true);
	  		   	return;
		  	}
		} catch (Exception e) {
