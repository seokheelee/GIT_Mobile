 ...
 * Subject : CJ Mall 
 * Name : TC_175
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 쇼핑찜 > 총~개 text 확인
 * Assertion : "총~개" Text 체크
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC175 {
	...
	@Test
	public void MyzoneShoppingzzimTotal() throws Exception {
		...
		try {
			...
			{
		    	System.out.println("[TC_175] failure : '총 ~ 개' 불일치");
				assertTrue(false);
			}
