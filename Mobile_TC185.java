 ...
 * Subject : CJ Mall 
 * Name : TC_185
 * Scenario : 전시 > 상단메뉴 > 로그인 > 마이존 > 방송알리미 > 수신동의  
 * Assertion : 수신동의 Text 확인
 * update : ScreenRecorder 기능 제거 (2016-06-16)
 */


public class Mobile_TC185 {
	...
	@Test
	public void MyzoneNotificationReciveAssent() throws Exception {
		...
		try {
			...
			element = driver.findElement(By.xpath(".//*[@id='ct']/div[3]/ul/li[8]/a"));
	  		...
	  		// 수신동의 '예' 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='smsDd']/span[1]/label")));
		  	System.out.println("수신동의 '예' 기다림");
			
			// 수신동의 '예' radio 버트 체크
			element = driver.findElement(By.xpath(".//*[@id='smsDd']/span[1]/label"));
	  		element.click();
		  	System.out.println("수신동의 '예' radio 버트 체크");
	  		
	  		// 수신동의 '아니오' 기다림
	  		wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='smsDd']/span[2]/label")));
		  	System.out.println("수신동의 '아니오' 기다림");
			
			// 수신동의 '아니오' radio 버트 체크
			element = driver.findElement(By.xpath(".//*[@id='smsDd']/span[2]/label"));
	  		element.click();
		  	System.out.println("수신동의 '아니오' radio 버트 체크");
			
			// 수신동의 Text 체크
			if ("수신동의".equals(driver.findElement(By.xpath(".//*[@id='ct']/div/form/div[1]/dl/dt[2]")).getText())) {
				System.out.println("[TC_185] success");
				assertTrue(true);
				return;
				
			} else {
				System.out.println("[TC_185] failure : 수신동의 불일치");
				assertTrue(false);
			}
